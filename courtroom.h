...
public:
	...
	//returns the char currently in use
	...
	//adds text to the IC chatlog. p_name first as bold then p_text then a newline
	...
	//plays the preanimation of the character currently speaking
	void play_preanim();
	...
	//called when CHECK#% is received from the server
...
private:
	...
	//times how long the realization flash should show
	QTimer *realization_timer;

	//these determine the rate of which the blinking "testimony" shows up
